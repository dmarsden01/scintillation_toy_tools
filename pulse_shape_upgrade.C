...
///////////////////
    ...
    //Rn222//
    TFile *fRn222 = new TFile("../new_data/a-gamma_test_2.root");
...
////////////
    ...
    //Rn222 with foils//
    vector<double> earliest_time_both_Rn222(number_events_Rn222,1000000);
    vector<double> fprompt_Rn222(number_events_Rn222,0);
    vector<int> quick_photon_Rn222(number_events_Rn222,0);
    vector<int> all_photon_Rn222(number_events_Rn222,0);

    //Rn222 without foils//
    vector<double> earliest_time_vuv_Rn222(number_events_Rn222,1000000);
    vector<double> fprompt_Rn222_vuv(number_events_Rn222,0);
    vector<int> quick_photon_Rn222_vuv(number_events_Rn222,0);
    vector<int> all_photon_Rn222_vuv(number_events_Rn222,0);
    ...
    for (int i = 0; i < size_data_tree_Rn222; i++) {
        ...
        all_photon_Rn222[data_eventRn222] ++;
        if (data_timeRn222 < earliest_time_both_Rn222[data_eventRn222]){
            earliest_time_both_Rn222[data_eventRn222] = data_timeRn222;
        }
    }
    ...
    for (int i = 0; i < size_data_tree_Rn222_vuv; i++) {
        ...
        all_photon_Rn222_vuv[data_eventRn222_vuv] ++;
        if (data_timeRn222_vuv < earliest_time_vuv_Rn222[data_eventRn222_vuv]){
            earliest_time_vuv_Rn222[data_eventRn222_vuv] = data_timeRn222_vuv;
        }
    }
    ...
    if(photon_cut == true){
      ...
      for(int i = 0; i < size_data_tree_Rn222; i++){//Let's try 6000 photons first
         ...
         data_treeRn222->GetEntry(i);
         if(all_photon_Rn222[data_eventRn222] > photon_cut_num){
           pulse_shape_Rn222->Fill(data_timeRn222 - earliest_time_both_Rn222[data_eventRn222]);
         }
      }
      ...
      for(int i = 0; i < size_data_tree_Rn222_vuv; i++){//Let's try 6000 photons first
         ...
         data_treeRn222_vuv->GetEntry(i);
         if(all_photon_Rn222_vuv[data_eventRn222_vuv] > photon_cut_num){
           pulse_shape_Rn222_vuv->Fill(data_timeRn222_vuv - earliest_time_vuv_Rn222[data_eventRn222_vuv]);
         }
      }
    }
    if(photon_cut == false){
...
*/
    ...
    for(int i = 0; i < size_data_tree_Rn222; i++){
      data_treeRn222->GetEntry(i);
      if((data_timeRn222 - earliest_time_both_Rn222[data_eventRn222])<biggest_diff_time*0.001){
        quick_photon_Rn222[data_eventRn222] ++;
      }
    }
    //Fprompt for Rn222 without foils//
    for(int i = 0; i < size_data_tree_Rn222_vuv; i++){
      data_treeRn222_vuv->GetEntry(i);
      if((data_timeRn222_vuv - earliest_time_vuv_Rn222[data_eventRn222_vuv])<biggest_diff_time_vuv*0.001){
        quick_photon_Rn222_vuv[data_eventRn222_vuv] ++;
      }
    }
    ...
    if(photon_cut == false){
      ...
      for(int i = 0;i<event_treeRn222->GetEntries();i++){
        ...
        if(all_photon_Rn222_vuv[i]==0){
          fprompt_Rn222_vuv[i]=0;
        }
        else{
          fprompt_Rn222_vuv[i] = quick_photon_Rn222[i]*1.0/all_photon_Rn222[i];
        }
...
//////////
    ...
    std::string out_front("output/pulse_shape_B8_alpha_100000_");
